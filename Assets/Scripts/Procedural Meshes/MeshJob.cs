...
namespace ProceduralMeshes{
        ...
        where S : struct, IMeshStreams
    {
           ...
           Vector3 extraBoundsExtents, bool supportVectorization)
        {
            ...
            job.streams.Setup(
                meshData, mesh.bounds = bounds, vertexCount, job.generator.IndexCount
            );
    ...
    public delegate JobHandle AdvancedMeshJobScheduleDelegate(Mesh mesh, Mesh.MeshData meshData, int resolution, JobHandle dependency, Vector3 extraBoundsExtents, bool supportVectorization);
}
