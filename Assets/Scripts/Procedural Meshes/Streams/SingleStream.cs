...
namespace ProceduralMeshes.Streams{
    public struct SingleStream : IMeshStreams {
        ...
        public void Setup(Mesh.MeshData meshData, Bounds bounds, int vertexCount, int indexCount){
            ...
            descriptor[2] = new VertexAttributeDescriptor(VertexAttribute.Tangent, VertexAttributeFormat.Float16, 4);
            descriptor[3] = new VertexAttributeDescriptor(VertexAttribute.TexCoord0, VertexAttributeFormat.Float16, 2);
